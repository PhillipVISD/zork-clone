...
import org.vashonsd.zork.Text.Parsing.NLP.NlpUtil;
...
public class TextInterpreter {
	...
	public static Tokenizer getTokenizer() {
		...
		try (InputStream modelIn = NlpUtil.class.getResourceAsStream("en-token.bin")) {
	...
	public static POSTaggerME getTagger() {
		...
		try (InputStream modelIn = NlpUtil.class.getResourceAsStream("en-pos-perceptron.bin")) {
